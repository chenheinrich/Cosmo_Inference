...
class GRSIngredients(Theory):
    ...
    cosmo_fid_file = "./src/spherex_cobaya/sample_inputs/cosmo_pars/planck2018_fiducial.yaml"
    survey_par_file = "./src/spherex_cobaya/sample_inputs/survey_pars/survey_pars_v27_base_cbe_Mar21.yaml"
