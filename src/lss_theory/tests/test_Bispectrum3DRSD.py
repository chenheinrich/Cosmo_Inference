...
@pytest.mark.parametrize("yaml_file, cosmo_par_file, fn_expected", \
    [
        ("./lss_theory/tests/data/get_bis_rsd.yaml", './inputs/cosmo_pars/planck2018_fiducial.yaml', './lss_theory/tests/data/bis_rsd_fnl_0.npy'), \
        ("./lss_theory/tests/data/get_bis_rsd.yaml", './inputs/cosmo_pars/planck2018_fnl_1p0.yaml', './lss_theory/tests/data/bis_rsd_fnl_1.npy'), \
    ]
)
