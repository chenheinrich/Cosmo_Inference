...
from lss_theory.covariance import BispectrumMultipoleCovariance
...
if __name__ == '__main__':
    """
    Example usage:
        python3 -m lss_theory.scripts.get_covariance_bis_mult ./galaxy_3d/inputs_theory/get_covariance_bis_mult.yaml
    """
