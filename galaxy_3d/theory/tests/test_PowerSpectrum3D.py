...
@pytest.mark.parametrize("yaml_file, cosmo_par_file, fn_expected", \
    [
        ("./theory/tests/data/get_ps.yaml", './inputs/cosmo_pars/planck2018_fiducial.yaml', './theory/tests/data/ps_fnl_0.npy'), \
        ("./theory/tests/data/get_ps.yaml", './inputs/cosmo_pars/planck2018_fnl_1p0.yaml', './theory/tests/data/ps_fnl_1.npy'), \
    ]
)
