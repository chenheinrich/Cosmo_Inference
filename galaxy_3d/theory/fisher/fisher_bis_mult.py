...
class BispectrumMultipoleDerivatives(Derivatives):
    ...
    def _get_signal_for_info(self, info): 
        from theory.scripts.get_bis_mult import get_galaxy_bis_mult
...
if __name__ == '__main__':
    """
    Example usage:
        python3 -m galaxy_3d.theory.fisher.fisher_bis_mult ./galaxy_3d/inputs_theory/get_fisher_bis_mult.yaml 
    """
