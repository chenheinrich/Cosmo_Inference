...
from theory.data_vector.data_vector import Bispectrum3DRSD_MurMuphi
import yaml
import os
import pickle
...
def get_data_spec(info):
    ...
    data_spec = Bispectrum3DRSDSpec_MurMuphi(survey_par, data_spec_dict)
    return data_spec
...
def get_b3d_rsd(info):
    ...
    data_vec = Bispectrum3DRSD_MurMuphi(grs_ingredients, survey_par, data_spec)
...
if __name__ == '__main__':
    """
    Example usage:
        python3 -m galaxy_3d.theory.scripts.get_bis_rsd_mur_muphi ./galaxy_3d/inputs_theory/get_bis_rsd_mur_muphi.yaml 
    """
